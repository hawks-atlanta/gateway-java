...
public class ITShareManagement {
	...
	void ShareFile() {
		...
		// 204
		ReqShareFile reqShareFile = TestUtilShare.createShareFile(resSaveFile1, username2, tokenUser1);
	...
	void UnshareFile() {
		...
		// 204
		ReqShareRemove reqShareRemove = new ReqShareRemove(tokenUser1, reqShareFile.fileUUID, reqShareFile.otherUsername);
		assertEquals(204, CtrlUnshareFile.unshare_file(reqShareRemove).code, "The file was unshared");

		// 409
		assertEquals(409, CtrlUnshareFile.unshare_file(reqShareRemove).code,
		...
		reqShareFile.fileUUID = resSaveFile2.fileUUID;
		assertEquals(403, CtrlUnshareFile.unshare_file(reqShareRemove).code, "The file is not owned by the user.");
		...
		assertEquals(500, CtrlUnshareFile.unshare_file(reqShareRemove).code, "Can't reach metadata");
	}
